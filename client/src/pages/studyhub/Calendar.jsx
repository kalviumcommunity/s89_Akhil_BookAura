...
const Calendar = () => {
  ...
  const fetchEvents = useCallback(async (start, end) => {
    try {
      ...
      const response = await axios.get('https://s89-akhil-bookaura-1.onrender.com/api/events', {
        params: { start, end },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (modalMode === 'add') {
        ...
        // Create new event
        response = await axios.post('https://s89-akhil-bookaura-1.onrender.com/api/events', eventData, {
          withCredentials: true,
          headers: {
            'Authorization': `Bearer ${authToken || ''}`
          }
        ...
        response = await axios.put(`https://s89-akhil-bookaura-1.onrender.com/api/events/${selectedEvent.id}`, eventData, {
          withCredentials: true,
          headers: {
            'Authorization': `Bearer ${authToken || ''}`
          }
  ...
  const handleDeleteEvent = async () => {
    ...
    try {
      ...
      const response = await axios.delete(`https://s89-akhil-bookaura-1.onrender.com/api/events/${selectedEvent.id}`, {
        withCredentials: true,
        headers: {
          'Authorization': `Bearer ${authToken || ''}`
        }
